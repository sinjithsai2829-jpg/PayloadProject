...
assert.ok(!revealSource.includes('collapsed.delete'), 'diff navigation must not expand user folds');
assert.ok(!revealSource.includes('notifyFoldState'), 'diff navigation must not mutate persisted fold state');
